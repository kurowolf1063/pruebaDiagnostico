...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-01-2024 a las 14:56:52
...
(1, 'Juan Morales Espinoza'),
(2, 'Christian Fuentes Barraza'),
(3, 'Roberto Lagos Ortega'),
(4, 'Patricio Lillo Payakan');
...
CREATE TABLE `comunas` (
  `id` int(11) NOT NULL,
  `comuna` varchar(64) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE `regiones` (
  ...
  `abreviatura` varchar(4) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `capital` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `votos` (`id`, `nombre`, `alias`, `rut`, `email`, `region`, `comuna`, `candidato`, `como_se_entero`, `fecha_creacion`) VALUES
(5, 'alexander riquelme', 'elenano', '242853199', 'alumno@google.com', '7', '86', '3', '', '2024-01-02 04:45:18'),
(6, 'yesenia irarrazabal', 'lachenia', '17341028k', 'yeseniairarrazabal@gmail.com', '4', '22', '4', 'web, tv, redes_sociales, amigos', '2024-01-02 05:11:19'),
(8, 'John Riquelme', 'eltonjohn', '181514868', 'yeseniairarrazabal@gmail.com', '3', '14', '1', 'web, amigos', '2024-01-02 05:27:03'),
(9, 'milton soto', 'monomilton', '171076889', 'miltonsoto@gmail.com', '8', '140', '4', 'web, redes_sociales', '2024-01-02 13:23:58');
